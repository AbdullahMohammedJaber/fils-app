      ...
      builder: (context, state) {
        return Column(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: List.generate(state.colorSelect.length, (
                              index,
                            ) {
                              return GestureDetector(
                                onTap: () {
                                  context
                                      ...
                                      .selectColorId(state.colorSelect[index]);
                                },
                                child: Container(
                                  decoration: BoxDecoration(
            ...
            state.selectColor && state.colorList != null
                ? Stack(
                  children: [
                    Container(
                      width: width,
                        ...
                        child: Scrollbar(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: List.generate(state.colorList!.length, (
                                  index,
                                ) {
                                  return Container(
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child:
                                                state.colorList![index].isSelect
                                                    ? Center(
                                                      child: SvgPicture.asset(
