...
class FormAddAuctionSeller extends StatefulWidget {
  const FormAddAuctionSeller({super.key});

  @override
  State<FormAddAuctionSeller> createState() => _FormAddAuctionSellerState();
}

class _FormAddAuctionSellerState extends State<FormAddAuctionSeller> {
  ...
  @override
  void initState() {
    context.read<AuctionSellerCubit>().clearForm();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<AuctionSellerCubit, AuctionSellerState>(
      listener: (context, state) {},
      builder: (context, state) {
        var controller = context.read<AuctionSellerCubit>();
        return Scaffold(
