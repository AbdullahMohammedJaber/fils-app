...
FavoritesResponse favoritesResponseFromMap(String str) => FavoritesResponse.fromMap(json.decode(str));

String favoritesResponseToMap(FavoritesResponse data) => json.encode(data.toMap());
